...
%calculate MEF for parachute
[M,MEF]=v2M_Mars(velocity,altitude);
% *************************************
...
if edl_system.parachute.deployed && ~edl_system.parachute.ejected
    %calculation is updated for changing Cd value
    ACd_parachute = pi*(edl_system.parachute.diameter/2.0)^2*edl_system.parachute.Cd*MEF;
else
    ACd_parachute = 0.0;
end
