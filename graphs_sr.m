...
subplot(3,1,1), plot(output2,output1), xlabel('Speed reducer torque [Nm]'),...
    ylabel('Speed reducer speed [rad/s]');
subplot(3,1,2), plot(output2,output3), xlabel('Speed reducer torque [Nm]'),...
    ylabel('Speed reducer power [Nm]');
subplot(3,1,3), plot(output1,output3), xlabel('Speed reducer speed [rad/s]'),...
